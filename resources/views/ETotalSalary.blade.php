            ...
            <div class="container-fluid" style="margin-top: 150px">
                ...
                <a href="{{url('/Esalary')}}">
                    <table class="table" style="width:300px;margin:10px auto 10px auto">
                        <thead class="thead-dark">
                        <tr class="btn">
                            <th class="text-center" scope="row" style="width:300px;height:10px; margin-left: -4ch;background-color:#264348;">
                                SALARY
                                MANAGEMENT
                            </th>
                        </tr>
        ...
        <div class="col-9">
            <div class="container-fluid" style="width: 1200px ;margin-left: -3ch">
                <ul class="my">
                    ...
                    <li class="my" style="background-color:#857373"><a href={{url('/MTsalary')}}><i class="fas fa-file-invoice-dollar fa-1x"></i> Total expenditure</a>
                    </li>
